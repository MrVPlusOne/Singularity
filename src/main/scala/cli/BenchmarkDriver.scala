...
object BenchmarkDriver {
  ...
  private def benchmarks(ioId: Int): Map[String, FuzzingTaskProvider] = {
    ...
    Map[String, FuzzingTaskProvider](
      ...
      "slowfuzz/pcre_regex0" -> regexNativeExample(0)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex1" -> regexNativeExample(1)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex2" -> regexNativeExample(2)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex3" -> regexNativeExample(3)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex4" -> regexNativeExample(4)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex5" -> regexNativeExample(5)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex6" -> regexNativeExample(6)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex7" -> regexNativeExample(7)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex8" -> regexNativeExample(8)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex9" -> regexNativeExample(9)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex10" -> regexNativeExample(10)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex11" -> regexNativeExample(11)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex12" -> regexNativeExample(12)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex13" -> regexNativeExample(13)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex14" -> regexNativeExample(14)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex15" -> regexNativeExample(15)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex16" -> regexNativeExample(16)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex17" -> regexNativeExample(17)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex18" -> regexNativeExample(18)(FileInteraction.getWorkingDir(ioId)),
      "slowfuzz/pcre_regex19" -> regexNativeExample(19)(FileInteraction.getWorkingDir(ioId)),
      // TODO: slowfuzz/bzip
